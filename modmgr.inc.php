...
function SDD_ModMgr()
{
  ...
  foreach($MOD_ARRAY as $ModPath)
  {
    ...
    if(strpos($URL,'github')!==FALSE) $update_Link="<a href=\"index.php?update=$PkgNum\" title=\"Perform GIT Pull to UPDATE Modlet\"  style=\"background-color:#FFFFFF;color:#000000;text-decoration:none\"><img align=top height=28 src=update.png ALT=\"Perform GIT Pull to UPDATE Modlet\"></a>";
    else $update_Link="";

    if($URL!='') $download_Link="<td width=90 align=center><a href=\"$URL\" title=\"Download Modlet\" style=\"background-color:#FFFFFF;color:#000000;text-decoration:none\"><img align=top height=28 src=direct-download.png alt=\"Download Modlet\"></a> $update_Link</td>";
