...
function SDD_ModMgr()
{
  ...
  foreach($MOD_ARRAY as $ModPath)
  {
    ...
    if(strpos($URL,'github')!==FALSE) $update_Link="<a href=\"index.php?update=$PkgNum\"><img align=top height=38 src=update.png ALT=\"Perform GIT Pull to UPDATE Modlet\"></a>";
    else $update_Link="";

    if($URL!='') $download_Link="<td width=100 align=center><a href=$URL><img align=top height=38 src=direct-download.png alt=\"Download Modlet\"></a> $update_Link</td>";
